<?php
$cookie_name = "cashier_token";
$cookie_path = "/cashier/"; // Must match the path used when setting the cookie
$cookie_domain = ""; // local
// $cookie_domain = "cashier.adzkasfr.com"; // hosting
...
setcookie($cookie_name, "", time() - 3600, "/cashier/", $cookie_domain, false, true);
...
header("Location: /cashier/auth/main.php?page=login"); // local
